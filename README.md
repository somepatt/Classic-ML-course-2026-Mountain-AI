...
| Блок | Время |
|---|---:|
| Интуиция и мотивация | 10–15 минут |
| Теория и формулы | 15–25 минут |
| Live coding | 40–60 минут |
| Практика / домашнее задание | 20–40 минут |
| Итоги урока | 5–10 минут |
...
Чтобы курс оставался сфокусированным, в основную программу не входят:
...
Эти темы можно изучать после прохождения курса по классическому ML.
